(
  function() {
    ...
    for (
      const o of document.querySelectorAll('link[rel="modulepreload"]')
    ) l(o);
    new MutationObserver(
      o => {
        for (const s of o) if (s.type === 'childList') for (const d of s.addedNodes) d.tagName === 'LINK' &&
          d.rel === 'modulepreload' &&
          l(d)
      }
    ).observe(document, {
...
function Kt(e, t) {
  for (let n = 0; n < e.length; n += 1) e[n] &&
    e[n].d(t)
}
function f(e) {
...
function u(e, t, n) {
  n == null ? e.removeAttribute(t) : e.getAttribute(t) !== n &&
    e.setAttribute(t, n)
}
function de(e) {
...
function At(e, t) {
  ...
  n &&
    n.slice().forEach(l => l.call(this, t))
}
const ht = [],
  Nt = [];
let mt = [];
...
function ee() {
  ...
  do {
    ...
    for (wt(null), ht.length = 0, ft = 0; Nt.length;) Nt.pop()();
...
function ne(e, t) {
  ...
  for (; s--;) {
    const d = e[s],
      i = t[s];
    if (i) {
      for (const r in d) r in i ||
        (l[r] = 1);
      for (const r in i) o[r] ||
        (n[r] = i[r], o[r] = 1);
      e[s] = i
    } else for (const r in d) o[r] = 1
  }
  for (const d in l) d in n ||
    (n[d] = void 0);
  return n
}
function le(e) {
...
function ve(e, t) {
  e.$$.dirty[0] === - 1 &&
    (ht.push(e), te(), e.$$.dirty.fill(0)),
    e.$$.dirty[t / 31 | 0] |= 1 << t % 31
}
function ct(e, t, n, l, o, s, d, i = [
  - 1
]) {
  const r = kt;
  wt(e);
  ...
  if (
    c.ctx = n ? n(
      ...
      (C, y, ...$) => {
        ...
        return c.ctx &&
          o(c.ctx[C], c.ctx[C] = w) &&
          (!c.skip_bound && c.bound[C] && c.bound[C](w), b && ve(e, C)),
          y
      }
    ) : [],
    c.update(),
...
function se(e, t = R) {
  ...
  function o(i) {
    if (st(e, i) && (e = i, n)) {
      const r = !pt.length;
      for (const c of l) c[1](),
        pt.push(c, e);
      if (r) {
        for (let c = 0; c < pt.length; c += 2) pt[c][0](pt[c + 1]);
        pt.length = 0
      }
    }
  }
...
function _e(e, t) {
  ...
  var n,
    ...
    i = '',
    r = e.split('/');
  for (r[0] || r.shift(); o = r.shift();) n = o[0],
    n === '*' ? (d.push('wild'), i += '/(.*)') : n === ':' ? (
      l = o.indexOf('?', 1),
      s = o.indexOf('.', 1),
...
function we(e) {
  ...
  function d(i) {
    let r = {};
    for (let c = 0; c < o.length; c += 1) r = Jt(r, o[c]);
    return {
      props: r
    }
  }
  return s &&
    (t = Et(s, d()), t.$on('routeEvent', e[7])),
  {
    c() {
      t &&
        bt(t.$$.fragment),
...
function Ee(e, t, n) {
  ...
  class d {
    constructor(m, h) {
      if (
        !h ||
        typeof h != 'function' &&
        (typeof h != 'object' || h._sveltesparouter !== !0)
      ) throw Error('Invalid component object');
      if (
        !m ||
        typeof m == 'string' &&
        (m.length < 1 || m.charAt(0) != '/' && m.charAt(0) != '*') ||
        typeof m == 'object' &&
        !(m instanceof RegExp)
      ) throw Error(
      ...
      this.path = m,
        typeof h == 'object' &&
          ...
          this.component = () => Promise.resolve(h),
          this.conditions = [],
          this.props = {}
        ),
        this._pattern = E,
    ...
    match(m) {
      if (o) {
        if (typeof o == 'string') if (m.startsWith(o)) m = m.substr(o.length) ||
          ...
          const B = m.match(o);
          if (B && B[0]) m = m.substr(B[0].length) ||
            '/';
          else return null
        }
      }
      ...
      if (this._keys === !1) return h;
      const E = {};
      let M = 0;
      for (; M < this._keys.length;) {
        try {
          E[this._keys[M]] = decodeURIComponent(h[M + 1] || '') ||
            null
        } catch {
          E[this._keys[M]] = null
        }
    ...
    async checkConditions(m) {
      for (let h = 0; h < this.conditions.length; h++) if (!await this.conditions[h](m)) return !1;
      return !0
    }
  }
  const i = [];
  ...
  s &&
    (
      w = p => {
        p.state &&
          (
            p.state.__svelte_spa_router_scrollY ||
            p.state.__svelte_spa_router_scrollX
          ) ? $ = p.state : $ = null
      },
  ...
  const x = Bt.subscribe(
    async p => {
      ...
      for (; m < i.length;) {
        ...
        h &&
          typeof h == 'object' &&
          Object.keys(h).length ? n(1, c = h) : n(1, c = null),
          n(2, b = i[m].props),
          y(
            'routeLoaded',
            Object.assign({
  ...
  return e.$$set = p => {
    'routes' in p &&
      ...
      'prefix' in p &&
      n(4, o = p.prefix),
      'restoreScrollState' in p &&
      n(5, s = p.restoreScrollState)
  },
    e.$$.update = () => {
      e.$$.dirty & 32 &&
...
function Ut(e) {
  ...
  return {
    ...
    p(o, s) {
      s & 1 &&
        (t = o[16].trim() != ''),
        t ? l ? l.p(o, s) : (l = Ft(o), l.c(), l.m(n.parentNode, n)) : l &&
          (l.d(1), l = null)
    },
    d(o) {
      l &&
...
function Ne(e) {
  let t,
    ...
    U = e[0][4].split(','),
    I = [];
  for (let k = 0; k < U.length; k += 1) I[k] = Ut(Zt(e, U, k));
  return {
    c() {
      t = f('div'),
        n = f('div'),
    ...
    <form method="dialog" class="modal-backdrop"><button>close</button></form>
      `,
        ...
        u(
          h,
          'class',
          'input input-bordered input-primary w-96 mb-5 border-3'
        ),
        u(
          q,
          'class',
          'textarea textarea-secondary textarea-md w-96 border-3 mb-5'
        ),
    ...
    p(k, [
      ...
      if (z & 1) {
        ...
        for (T = 0; T < U.length; T += 1) {
          const j = Zt(k, U, T);
          I[T] ? I[T].p(j, z) : (I[T] = Ut(j), I[T].c(), I[T].m(i, null))
        }
...
function Oe(e, t, n) {
  ...
  const b = async (g, p, m, h) => {
    ...
    try {
      ...
      if (!q.ok) throw new Error('Failed to edit note');
...
function Pe(e) {
  let t,
    ...
    T = e[0],
    j = [];
  for (let v = 0; v < T.length; v += 1) j[v] = Yt(Wt(e, T, v));
  ...
  return {
    c() {
      t = f('div'),
        ...
        P = _(),
        x = f('div');
      for (let v = 0; v < j.length; v += 1) j[v].c();
      O = _(),
        g = f('dialog'),
        p = f('div'),
        m = f('div'),
  ...
  <form method="dialog" class="modal-backdrop"><button>close</button></form>
    ...
    m(v, H) {
      S(v, t, H),
        ...
        a(w, P),
        a(w, x);
      for (let D = 0; D < j.length; D += 1) j[D] &&
        j[D].m(x, null);
      S(v, O, H),
        S(v, g, H),
        a(g, p),
    ...
    p(v, [
      ...
      if (H & 17) {
        ...
        for (D = 0; D < T.length; D += 1) {
          const It = Wt(v, T, D);
          j[D] ? (j[D].p(It, H), K(j[D], 1)) : (j[D] = Yt(It), j[D].c(), K(j[D], 1), j[D].m(x, null))
        }
        for (Lt(), D = T.length; D < j.length; D += 1) ie(D);
        St()
      }
      H & 2 &&
        E.value !== v[1] &&
    ...
    i(v) {
      if (!I) {
        for (let H = 0; H < T.length; H += 1) K(j[H]);
        I = !0
      }
    },
    o(v) {
      j = j.filter(Boolean);
      for (let H = 0; H < j.length; H += 1) Q(j[H]);
      I = !1
    },
    d(v) {
      v &&
...
function Be(e, t, n) {
  ...
  const o = async () => {
    ...
    try {
      ...
      x.ok ||
        (fail_get_modal.showModal(), localStorage.removeItem('token')),
        n(0, l = await x.json())
    } catch (x) {
    ...
    <nav class="svelte-1ppaie9"><h6 class="footer-title svelte-1ppaie9">Social</h6>  
      ...
      `,
        u(
          l,
          'class',
          'footer p-10 bg-slate-900 text-neutral-content svelte-1ppaie9'
        )
    },
    m(s, d) {
      it(t, s, d),
